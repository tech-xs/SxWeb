<template>
  <a-form layout="vertical"
    ...
    <a-form-item>
      <a-button size="large" type="primary" html-type="submit">重置密码</a-button>
...
<script>
import {getResetPasswordEmailVerificationCode, resetPasswordEmail} from "@/api/sys/user";
...
export default {
  ...
  methods: {
    resetPassword() {
      ...
      resetPasswordEmail(data).then(res => {
        if (res.code == 200) {
    ...
    getEmailCode() {
      ...
      getResetPasswordEmailVerificationCode(email)
    }
  }
}
</script>
